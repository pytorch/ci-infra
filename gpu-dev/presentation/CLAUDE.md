...
- **Max reservation time** - Maximum reservation duration is 48 hours for multi-GPU reservations; single-GPU reservations can be extended repeatedly with no total duration limit
