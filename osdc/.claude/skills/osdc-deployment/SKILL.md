...
```yaml
arc:
  chart_version: "0.14.1-jeanschmidt.12"   # Must match controller + runner charts (minor mismatch deletes ARS). Fork chart from jeanschmidt/actions-runner-controller. Check clusters.yaml for the current value.
