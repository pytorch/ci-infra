...
| `docs/nvidia-driver-ahead-of-aws.md` | Where the GPU driver comes from (stock EKS NVIDIA AMI, R580), why CUDA 13.4 wants R615, and the options for moving ahead of AWS's schedule |
