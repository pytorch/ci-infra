...
INSTANCE_SPECS: dict[str, dict] = {
    ...
    "r7g.12xlarge": {"vcpu": 48, "memory_gib": 384, "memory_mi": 363724, "gpu": 0, "arch": "arm64"},
    ...
    # memory_mi estimated (memory_gib * 1024 * 0.925), not collected: no 4xlarge
    # GPU node has been provisioned in any cluster yet. Re-run
    # collect_instance_memory.py once one exists.
