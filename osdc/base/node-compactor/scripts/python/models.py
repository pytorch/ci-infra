...
class Config:
    ...
    gpu_quarantine_enabled: bool
    gpu_quarantine_threshold: int
    gpu_quarantine_window_seconds: int
    gpu_quarantine_max_fleet_ratio: float
