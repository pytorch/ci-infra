...
| Directory | Contents |
|-----------|----------|
| `kubernetes/` | Base k8s resources: gp3 StorageClass, NVIDIA device plugin, git-cache-server StatefulSet, git-cache-warmer DaemonSet, Harbor namespace, node performance tuning |
