...
def generate_deployment_yaml(
    ...
    log_info(f"amd64 ({amd64_instance}): {amd64_res['cpu']} vCPU, {amd64_res['memory_gi']}Gi per pod "
...
{userdata}
  ...
  tags:
    ...
    log_info(f"NodePool limits — arm64: {arm64_cpu_limit} CPU, {arm64_mem_limit}Gi | "
